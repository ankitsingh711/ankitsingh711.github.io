      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          >
            ...
            {/* Availability */}
            <div
              className="sui-card p-5 relative overflow-hidden"
              style={{ borderLeft: '2px solid rgba(34,197,94,0.4)' }}
            >
              {/* subtle green glow */}
              <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 80% 60% at 10% 50%, rgba(34,197,94,0.06) 0%, transparent 70%)' }} />
              <div className="relative flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <p className="text-on-surface-variant text-xs font-inter uppercase tracking-wider">Availability</p>
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-inter font-semibold bg-green-500/10 text-green-400 border border-green-500/20">
                      <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />
                      Open to Work
                    </span>
                  </div>
                  <p className="text-on-background font-inter font-medium text-sm">Freelance &amp; Full-time</p>
                  <div className="mt-3 space-y-1.5">
                    <div className="flex items-center gap-2 text-xs text-on-surface-variant font-inter">
                      <svg className="w-3.5 h-3.5 text-green-400/70 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
