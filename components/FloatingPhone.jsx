...
export default function FloatingPhone() {
  return (
    <>
      {/* WhatsApp — visible on mobile/tablet only */}
      <motion.a
        ...
        className="lg:hidden fixed bottom-6 right-20 z-[1000] flex items-center justify-center w-12 h-12 bg-[#25D366] text-white rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all duration-300"
      ...
      {/* Desktop stack — email, WhatsApp, phone */}
